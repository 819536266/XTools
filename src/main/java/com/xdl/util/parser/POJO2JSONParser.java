...
import com.xdl.exception.KnownException;
import com.xdl.util.parser.type.*;
...
public abstract class POJO2JSONParser {
    ...
    public String psiClasstToJSONString(@NotNull final PsiClass psiClass) {
        Object result = parseClass(psiClass, 0, List.of(), Map.of());
    ...
    private Map.Entry<String, Object> parseField(PsiField field, int level, List<String> ignoreProperties,
        ...
        if (docComment != null) {
            ...
            if (annotation != null) {
                ignoreProperties = POJO2JSONParserUtils.arrayTextToList(annotation.findAttributeValue("value")
                        .getText());
            }
        }
    ...
    private String parseFieldKey(PsiField field) {
        ...
        if (annotation != null) {
            String fieldName = POJO2JSONParserUtils.psiTextToString(annotation.findAttributeValue("value")
                    .getText());
        ...
        if (annotation != null) {
            String fieldName = POJO2JSONParserUtils.psiTextToString(annotation.findAttributeValue("name")
                    .getText());
            if (StringUtils.isNotBlank(fieldName)) {
                return fieldName;
            }
    ...
    private Object parseFieldValueType(PsiType type,
        ...
        if (type instanceof PsiPrimitiveType) {       //primitive Type
            ...
            if (psiClass.isEnum()) { // enum
                ...
                boolean iterable = fieldTypeNames.stream()
